        ...
        try {
            ...
            if (Preguntas != null && !Preguntas.isEmpty()) {
                ...
                for (PreguntaOpciones model : Preguntas) {
                    ...
                    if ((numRespRellenas < numMinResp121517 || numRespRellenas > MenuMapTiposOpciones.numOpciones.get(preguntas.getAttribute("tipo"))) && (TipoJuego.equals("Tipo12") || TipoJuego.equals("Tipo15") || TipoJuego.equals("Tipo17"))) {
                        RespInsuficientes = true;
                        RespVariables = true;
                    } else if ((numRespRellenas < numMinResp19 || numRespRellenas > MenuMapTiposOpciones.numOpciones.get(preguntas.getAttribute("tipo"))) && (TipoJuego.equals("Tipo19"))) {
                        RespInsuficientes = true;
                        RespVariables = true;
                    } else if (MenuMapTiposOpciones.numOpciones.get(preguntas.getAttribute("tipo")) != numRespRellenas && (!TipoJuego.equals("Tipo12") && !TipoJuego.equals("Tipo15") && !TipoJuego.equals("Tipo19") && !TipoJuego.equals("Tipo17"))) {
                        RespInsuficientes = true;
                    }

                    if (!RespInsuficientes) {
